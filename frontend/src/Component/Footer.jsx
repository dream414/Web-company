...
export default function Footer() {
      ...
      <div className="container px-4 flex flex-col items-center justify-center">
        ...
        >
          ...
          <motion.div variants={sectionVariant}>
            ...
            <form className="flex flex-col sm:flex-row gap-2 justify-center items-center w-full max-w-md mx-auto">
              <input
                type="email"
                className="flex-1 h-12 w-40 rounded-md border px-3 py-2 bg-white/10 border-white/20 text-white placeholder:text-gray-300 text-base focus:outline-none focus:ring-2 focus:ring-green-600"
                placeholder="Enter your email"
                required
              />
              <button
                className="h-10 px-4 py-2 W-20 bg-green-600 hover:bg-green-700 text-white rounded-md text-sm flex-shrink-0"
                type="submit"
              >
                Subscribe
              </button>
            ...
            <motion.div variants={iconVariant} className="mt-6 flex space-x-4 justify-center text-white">
              <a href="#" className="hover:text-green-600 transition-colors"><Linkedin className="w-5 h-5 inline mr-1"/>LinkedIn</a>
              <a href="#" className="hover:text-green-600 transition-colors"><Github className="w-5 h-5 inline mr-1"/>GitHub</a>
              <a href="#" className="hover:text-green-600 transition-colors"><Youtube className="w-5 h-5 inline mr-1"/>YouTube</a>
            </motion.div>
          </motion.div>
        </motion.div>
  ...
  <span className="relative z-10">Subscibe for GIS offers</span>
